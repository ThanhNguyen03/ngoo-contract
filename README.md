...
On-chain crypto payment contract for the [Ngoo food ordering platform](https://github.com/thanhfng/ngoo-server-2025), deployed on Ethereum Sepolia (chain ID 11155111).
...
2. **User calls `payOrder`** — submits the proof along with the exact ETH amount; the contract verifies the signature and records the payment.
